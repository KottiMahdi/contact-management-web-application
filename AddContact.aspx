        ...
        <div>
           <dx:ASPxFormLayout runat="server" Width="100%"  ID="formLayout" ColumnCount="1" DataSourceID="SqlDataSource1" Theme="Glass" AlignItemCaptionsInAllGroups="True"  > 
                        <Items>
                            ...
                            <dx:LayoutGroup Caption="Ajouter contact" ColCount="2" >
                                <Items>

                            <dx:LayoutItem    Caption="Civ" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="cmbCiv" runat="server" TextField="Civilite"  ValueField="ID_Civ" Width="275px" BackColor="lightyellow" DataSourceID="SqlCivilit">
                                        </dx:ASPxComboBox>
                            ...
                            <dx:LayoutItem  Caption="Prénom"  >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="TxtPrenom" runat="server" Width="100%" BackColor="lightyellow">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem  Caption="Téléphone"  >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="TxtTelephone" runat="server" Width="100%" BackColor="lightyellow" Number="0">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem  Caption="Mobile" >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="TxtMobile" runat="server" Width="100%" BackColor="lightyellow" Number="0">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem   Caption="Email">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxTextBox ID="TxtEmails" runat="server"  Width="100%" BackColor="lightyellow">
                                        </dx:ASPxTextBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                            <dx:LayoutItem   Caption="Fonction">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        <dx:ASPxComboBox ID="cmbFonction" runat="server" Width="100%" BackColor="lightyellow" DataSourceID="sqlFonction" TextField="Fonction"  ValueField="ID_Fonction">
                                        </dx:ASPxComboBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
